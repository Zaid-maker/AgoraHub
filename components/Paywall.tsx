        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto">
            ...
            <div className="relative w-full max-w-5xl glass p-8 md:p-12 rounded-[4rem] border border-white/20 shadow-2xl animate-in fade-in zoom-in duration-500 my-8">
                <div className="text-center mb-12">
                    <div className="w-20 h-20 bg-gold/10 rounded-3xl flex items-center justify-center mx-auto mb-6 relative group">
                        <div className="absolute inset-0 bg-gold/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all" />
